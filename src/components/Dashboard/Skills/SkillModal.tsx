...
const SkillModal = ({
  ...
  if (isLoading) {
    return (
      <div className="text-gray-100 text-3xl text-center mt-2">Loading...</div>
    );
  }

  if (error) {
    return (
      <div className="text-gray-100 text-3xl text-center mt-2">
        Error...........
      </div>
    );
  }
            ...
            >
              ...
              <div className="flex flex-col mb-3">
                ...
                <input
                  ...
                  type="text"
                  className="text-black border border-gray-400 dark:bg-slate-900 rounded-md px-3 py-2"
                />
                {errors.name && (
